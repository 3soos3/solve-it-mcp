...
class TestGetAllTechniquesWithNameAndIdTool:
    ...
    async def test_error_handling(self, mock_solve_it_environment):
        ...
        with (
            ...
            tool.knowledge_base.get_all_techniques_with_name_and_id.side_effect = Exception(
                "Test error"
            )
...
class TestGetAllWeaknessesWithNameAndIdTool:
    ...
    async def test_successful_weaknesses_retrieval(self, mock_solve_it_environment):
        ...
        with (
            patch.object(GetAllWeaknessesWithNameAndIdTool, "_resolve_data_path"),
    ...
    async def test_error_handling(self, mock_solve_it_environment):
        ...
        with (
            ...
            tool = GetAllWeaknessesWithNameAndIdTool()
            tool.knowledge_base = MagicMock()
            tool.knowledge_base.get_all_weaknesses_with_name_and_id.side_effect = Exception(
                "Test error"
            )
...
class TestGetAllMitigationsWithNameAndIdTool:
    ...
    async def test_successful_mitigations_retrieval(self, mock_solve_it_environment):
        ...
        with (
            patch.object(GetAllMitigationsWithNameAndIdTool, "_resolve_data_path"),
    ...
    async def test_error_handling(self, mock_solve_it_environment):
        ...
        with (
            ...
            tool = GetAllMitigationsWithNameAndIdTool()
            tool.knowledge_base = MagicMock()
            tool.knowledge_base.get_all_mitigations_with_name_and_id.side_effect = Exception(
                "Test error"
            )
...
class TestGetAllTechniquesWithFullDetailTool:
    ...
    async def test_error_handling(self, mock_solve_it_environment):
        ...
        with (
            ...
            tool = GetAllTechniquesWithFullDetailTool()
            tool.knowledge_base = MagicMock()
            tool.knowledge_base.get_all_techniques_with_full_detail.side_effect = Exception(
                "Test error"
            )
...
class TestGetAllWeaknessesWithFullDetailTool:
    ...
    async def test_successful_weaknesses_retrieval(self, mock_solve_it_environment):
        ...
        with (
            patch.object(GetAllWeaknessesWithFullDetailTool, "_resolve_data_path"),
    ...
    async def test_error_handling(self, mock_solve_it_environment):
        ...
        with (
            ...
            tool = GetAllWeaknessesWithFullDetailTool()
            tool.knowledge_base = MagicMock()
            tool.knowledge_base.get_all_weaknesses_with_full_detail.side_effect = Exception(
                "Test error"
            )
...
class TestGetAllMitigationsWithFullDetailTool:
    ...
    async def test_successful_mitigations_retrieval(self, mock_solve_it_environment):
        ...
        with (
            patch.object(GetAllMitigationsWithFullDetailTool, "_resolve_data_path"),
    ...
    async def test_error_handling(self, mock_solve_it_environment):
        ...
        with (
            ...
            tool = GetAllMitigationsWithFullDetailTool()
            tool.knowledge_base = MagicMock()
            tool.knowledge_base.get_all_mitigations_with_full_detail.side_effect = Exception(
                "Test error"
            )
...
class TestBulkToolsPerformance:
    ...
    async def test_bulk_tools_consistency(self, mock_solve_it_environment):
        ...
        for tool_class, params_class in concise_tools:
            with (
                patch.object(tool_class, "_resolve_data_path"),

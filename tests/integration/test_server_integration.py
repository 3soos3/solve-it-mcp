...
class TestServerIntegration:
    ...
    def test_tool_workflow_database_description(self, mock_solve_it_environment):
        ...
        from tools.solveit_tools import GetDatabaseDescriptionParams, GetDatabaseDescriptionTool
    ...
    def test_tool_workflow_objective_management(self, mock_solve_it_environment):
        ...
        with (
            patch.object(ListObjectivesTool, "_resolve_data_path"),
    ...
    def test_tool_workflow_mapping_management(self, mock_solve_it_environment):
        ...
        with (
            patch.object(ListAvailableMappingsTool, "_resolve_data_path"),
...
class TestErrorHandlingIntegration:
    ...
    def test_data_path_resolution_failure(self):
        ...
        with patch(
            "utils.data_path.get_solve_it_data_path", side_effect=Exception("Path not found")
        ):
    ...
    def test_tool_error_propagation(self, mock_solve_it_environment):
        ...
        from tools.solveit_tools import SearchParams, SearchTool
